...
[사전직무교육 신청](https://abcbootcamp.kr/abc_education/abc_education_detail/EDUA_000000104/)
...
- 프로젝트 준비 문서
  ...
  - [GitHub 제출 예시](doc/GitHub_제출_예시.md)
  - [발표 구성 템플릿](doc/발표_구성_템플릿.md)
...
- 수업 목표
  - Python을 이용한 프로그래밍을 통해 데이터 분석과 웹 개발에 필요한 기술을 익힌다.
